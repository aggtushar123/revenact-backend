...
| `anomalies.*` | confidential | — | `AnomalyEvidence.snippet` copies a report's own text; read only by members who may open the company and may read the source record |
